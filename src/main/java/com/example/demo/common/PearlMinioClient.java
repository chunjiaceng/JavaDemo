 ...
 * @version 1.0.0
 * @ClassName PearlMinioClient.java
 * @Description TODO 自定义MinioClient
 * @createTime 2024年07月02日 20:12:00
 */

//1. 创建分片上传请求，并获取分片ID ---》 前端进行上传2. 查询各个分片信息 3. 根据uploadId合并远程分片文件
public class PearlMinioClient extends MinioClient {
     ...
     */
    @Override
    public CreateMultipartUploadResponse createMultipartUpload(String bucketName, String region, String objectName, Multimap<String, String> headers, Multimap<String, String> extraQueryParams) throws NoSuchAlgorithmException, InsufficientDataException, IOException, InvalidKeyException, ServerException, XmlParserException, ErrorResponseException, InternalException, InvalidResponseException, ServerException, InsufficientDataException, ErrorResponseException, NoSuchAlgorithmException, IOException, InvalidKeyException, XmlParserException, InvalidResponseException {
